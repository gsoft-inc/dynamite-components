...
if (-not (Test-Path $DestinationPath)) 
{
	...
	Copy-DSPFiles -Path $DefaultDefinitionsPath -DestinationPath $DestinationPath -Match @("*.ps1","*.template.*","*.xlsx","*.jpg","*.jpeg","*.png","*.sgt", "README*", "*.psd1", "*.psm1") -Exclude "Install.ps1"
