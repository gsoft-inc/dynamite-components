...
{
    public class BaseNavigationFieldInfoConfig : IBaseNavigationFieldInfoConfig
    {
        ...
        public BaseNavigationFieldInfoConfig(BaseNavigationFieldInfos baseMultilingualismFieldInfos)
        {
