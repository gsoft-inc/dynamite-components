...
namespace GSoft.Dynamite.Multilingualism.Core.Configuration
{
    ...
    /// </summary>
    public class BaseMultilingualismFieldInfoConfig : IBaseMultilingualismFieldInfoConfig
    {
        ...
        public BaseMultilingualismFieldInfoConfig(BaseMultilingualismFieldInfos baseMultilingualismFieldInfos)
        {
