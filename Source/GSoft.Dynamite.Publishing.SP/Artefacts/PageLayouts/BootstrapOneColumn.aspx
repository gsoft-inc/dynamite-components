...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
    ...
    <div class="row">
        <div class="col-xs-12">
	    	<WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_Left%>" ID="MainColumn" Orientation="Vertical"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
        </div>        
    </div>
</asp:Content>
