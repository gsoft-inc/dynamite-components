...
<asp:content contentplaceholderid="PlaceHolderMain" runat="server">
    <div class="row two-columns">
        ...
        <div class="colunm-half">
            <WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_Header%>" ID="Right"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
        </div>
	</div>
	<div class="row one-column">
	    <WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_Main%>" ID="Main"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
	</div>
</asp:content>
