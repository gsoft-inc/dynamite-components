...
<script type="text/javascript">
    GSoft.Dynamite.ContactForm.Initialize("<%=this.EmailAddress%>", "<%=this.ContactFormTemplate%>", "<%=this.JavaScriptViewModel%>", "<%=this.SuccessMessage%>", "<%=this.ErrorMessage%>", "<%=this.ValidationRules%>");
</script>   