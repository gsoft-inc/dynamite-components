...
<div class="contact-form">
    ...
    <div class="contact-form form-body">
            ...
            <span id="form-submit" class="form-submit" data-bind="text:$root.Form.SubmitLabel"></span>
    </div>
...
<script type="text/javascript" src="../../../../_layouts/15/GSoft.Dynamite.Publishing/Js/messages_fr.js"></script>
