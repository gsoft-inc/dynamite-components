...
{
    public class DynamiteDemoCatalogInfoValues
    {
        ...
        public DynamiteDemoCatalogInfoValues(IResourceLocator resourceLocator,
            DynamiteDemoContentTypeInfoValues contentTypeInfoValues,
