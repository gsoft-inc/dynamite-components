...
#Initialize-DSPFeature -Url [[DSP_PortalPublishingSiteUrl]]  -Id [[DSP_CommonCMS_PUB_ResultSources]]

#Write-Warning "Opening up the search REST API to anonymous users..."

#Initialize-DSPFeature -Url [[DSP_PortalPublishingSiteUrl]]  -Id [[DSP_CommonCMS_PUB_SearchRESTAnonymous]]
