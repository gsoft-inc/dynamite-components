...
INTRODUCTION
#########################################
You've installed the standard publishing CMS model NuGet package!  Now... what does this thing do exactly?  Here's the lowdown:
...
(..\..\Libraries\GSoft.Dynamite.StandardPublishingCMS.*) and your scripts project on which this package is installed.
